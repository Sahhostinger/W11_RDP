...
link1_status=$(curl -Is -k https://drive.google.com/u/0/uc?export=download&confirm=r9KW&id=1fDuj5WGy3vCYYFDZ3syz1dWqQPSh7BEi| grep HTTP | cut -f2 -d" " | head -1)
link2_status=$(curl -Is -k https://drive.google.com/u/0/uc?export=download&confirm=r9KW&id=1fDuj5WGy3vCYYFDZ3syz1dWqQPSh7BEi | grep HTTP | cut -f2 -d" ")
sudo wget -O Windows10 tao.qcow2 https://drive.google.com/u/0/uc?export=download&confirm=r9KW&id=1fDuj5WGy3vCYYFDZ3syz1dWqQPSh7BEi
[ -s lite11.qcow2 ] || sudo wget -O Windows10 tao.qcow2 https://transfer.sh/1XQtaoZ/lite11.qcow2
